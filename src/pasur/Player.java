...
public abstract class Player extends Publisher
{
    ...
    public final Map.Entry<Card, Set<Card>> playCard(Hand pool)
    {
        ...
        if(playedCard != null)
        {
            publishEvent(this,toString() + " plays " + Pasur.toString(playedCard));
    ...
    public int getScore(CompositeScoringStrategy cs)
    {
        int[] tmp = cs.getScore(this);
        currScore = tmp[0] + tmp[1];
